...
class SistemaTriagemBayesiana:
    ...
    def _construir_cpts(self) -> None:
        ...
        cpd_idade = TabularCPD(
            variable="IdadeAvancada", variable_card=2, 
            values=[[0.7], [0.3]],
        ...
        cpd_gravidade = TabularCPD(
            ...
            evidence=["IdadeAvancada"], evidence_card=[2],
            state_names={
        ...
        cpd_saturacao = TabularCPD(
            variable="SaturacaoO2", variable_card=2,
            values=[
                [0.95, 0.70, 0.10],  # Normal
                [0.05, 0.30, 0.90]   # Baixa
            ],
            evidence=["Gravidade"], evidence_card=[3],
            state_names={
        ...
        cpd_frequencia = TabularCPD(
            variable="FrequenciaCardiaca", variable_card=2,
            values=[
        ...
        cpd_nivel_dor = TabularCPD(
            variable="NivelDor", variable_card=2,
            values=[
                [0.80, 0.40, 0.15],  # Leve
        ...
        self.model.add_cpds(cpd_idade, cpd_gravidade, cpd_saturacao, cpd_frequencia, cpd_nivel_dor, cpd_febre)

    def calcular_probabilidade_gravidade(self, evidencias: Dict[str, str]) -> Dict[str, float]:
        """
